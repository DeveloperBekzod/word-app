...
<div>
    ...
    <div class="mt-2">
        <textarea {{ $disabled ? 'disabled' : '' }} id="{{ $attributes['name'] }}" autocomplete required {!! $attributes->merge([
            'class' =>
                'block w-full rounded-md border-0 py-2.5 text-black text-[14px] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600',
